...
protected:
    ...
    */
    ...
    /**
    * Function updates lines and arrow.
    * @param lines Pointer to the updated line
    * @param update Whether the line should really update (or just calculate new position)
    */
